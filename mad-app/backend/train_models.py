...
class DatasetPreparator:
    ...
    def __init__(self, base_path: str):
        ...
        self.datasets = {
            ...
            'hydraulic_support_guard_plate _data2023_yolo': 'hydraulic_support',
            'large_coal_data2023_yolo': 'large_coal',
            'mine_safety_helmet__data2023_yolo': 'mine_safety_helmet',
            'miner_behavior _data2023_yolo': 'miner_behavior',
            'towline _data2023_yolo': 'towline'
        }
    ...
    if args.train_all:
        ...
        for dataset_name in preparator.datasets.keys():
            ...
            if data_yaml:
                ...
                training_results[dataset_name] = metrics
        ...
        if general_yaml:
            ...
            training_results['general'] = metrics
        ...
        if args.dataset in preparator.datasets:
            ...
            if data_yaml:
                ...
                metrics = trainer.evaluate_model(model_path, data_yaml)
                training_results[args.dataset] = metrics
        else:
